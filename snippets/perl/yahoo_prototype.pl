...
#my $url = "https://search.yahoo.co.jp/";
my $url = "https://news.yahoo.co.jp/";

$mech->get( $url );
&mstat;

$mech->follow_link( url => 'https://news.yahoo.co.jp/hl?c=loc' );
&mstat;

$mech->follow_link( url => 'https://news.yahoo.co.jp/hl?c=kan' );
&mstat;

$mech->follow_link( url => 'https://news.yahoo.co.jp/hl?c=l12' );
&mstat;
print $mech->content() , "\n";
